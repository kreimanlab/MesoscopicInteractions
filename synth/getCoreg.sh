...
do
    ...
    mkdir $i/surf
    mkdir $i/label
    rsync -avP /mnt/cuenap_ssd/coregistration/$i/elec_recon ./$i/
    rsync -avP /mnt/cuenap_ssd/coregistration/$i/surf/rh.pial ./$i/surf/
    rsync -avP /mnt/cuenap_ssd/coregistration/$i/surf/lh.pial ./$i/surf/
    rsync -avP /mnt/cuenap_ssd/coregistration/$i/label/*all_* ./$i/label/
    rsync -avP /mnt/cuenap_ssd/coregistration/$i/label/*MACAQUE* ./$i/label/
    rsync -avP /mnt/cuenap_ssd/coregistration/$i/label/*HCP* ./$i/label/
    rsync -avP /mnt/cuenap_ssd/coregistration/$i/label/*.mat ./$i/label/
done
