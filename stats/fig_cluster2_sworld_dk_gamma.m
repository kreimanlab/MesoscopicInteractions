...
fn_ca = './cache/xsub_out_all_5.mat';
Ca = load(fn_ca);
...
for i = 1:length(rois)
    ...
    if (sum(strcmp(rois2_raw,t_roi)) == 0)
        ...
        elseif strcmp(rois{i},'parstriangularis')
            rois2_pts(i,2) = rois2_pts(i,2) + 14.5; % left-right
            rois2_pts(i,3) = rois2_pts(i,3) + 0;
...
% save
print(h,'./figures/fig_cluster2_sworld_dk_gamma','-depsc','-r400');
print(h,'./figures/fig_cluster2_sworld_dk_gamma','-dpng','-r400');
close(h);
