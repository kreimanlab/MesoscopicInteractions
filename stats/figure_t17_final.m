...
% Final number of clusters to plot
k_const = 8;
col_const = [245, 95,255;...
              94,  0,255;...
               0, 94,255;...
             157,  0,236;...
               0,189,236;...
...
%             cc_k = col_const;
    ...
    %             end
            ...
            print(h,sprintf('figures/T17/_final_kmeans-%i_%s_%s_nosig-%i',K(k),metric(3:end),SURFACE_TYPE,trig_blot_nosig),'-depsc');
            print(h,sprintf('figures/T17/_final_kmeans-%i_%s_%s_nosig-%i',K(k),metric(3:end),SURFACE_TYPE,trig_blot_nosig),'-dpng','-r400');
            close(h);
            ...
            print(h,sprintf('figures/T17/_final_kmeans-%i_%s_%s_nosig-%i_tsne',K(k),metric(3:end),SURFACE_TYPE,trig_blot_nosig),'-depsc','-r400');
            close(h);
        end
