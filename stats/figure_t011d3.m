% All interactions with 58 (pars tri), 10 seconds
...
%     end
    ...
    sig_i = (Ca.Dmats > Ca.dist_thresh) & (R > Ca.coh_thresh); % Ca.mag
    mag = double(R(sig_i));
    ...
    system('mkdir figures/T011d3');
    oname = sprintf('figures/T011d3/fsaverage_sym_remap_avgMM-%i_medianMM-%i',...
