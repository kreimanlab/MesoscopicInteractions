...
elseif contains(host,'Leibniz')
    dir_art = '/Volumes/KLAB101/behavior/h5_notch20/art'; %'/media/klab/internal/data/h5_notch20/art';
    dir_res = '/Volumes/KLAB101/results/w2';
    dir_cor = '/Volumes/KLAB101/coreg'; %'/mnt/cuenap_ssd/coregistration';
    dir_h5 = '/Volumes/KLAB101/behavior/h5_notch20';
...
%                                     struct('AcquisitionFunctionName','expected-improvement-plus'));
        ...
        if (trig_svm)
            ofname = sprintf('./cache/plot_24h_sw_trainsvm_metric-%i_%s_perm',metrici,bstr);
        else
            ofname = sprintf('./cache/plot_24h_sw_train_metric-%i_%s_perm',metrici,bstr);
        end
