...
for iM = 1 %1:length(metrics)
    for iSub = 1:length(SubjectsL)
        ...
        for atlM = 2 %1:20
            ...
            load(sprintf('%s/xsub_out_%s_%i_atl%i_noT.mat',dir_cacheL,SubjectsL{iSub},iM,atlM));
            n_rois_sav = n_rois;
            n_rois = ecog.n_bchan;
            sid = sid_sav;
            iSub = iSub_sav;
            ...
            for iii = 3 %1:3
                ...
                fn_ca = sprintf('./cache/xsub_out_m00005_%i_atl2_noT.mat',iM);
                Ca = load(fn_ca);
...
%                 end
                ...
                if (trig_perform_random_init)
                    ...
                    save('fig_cluster2_sworld_circle_E_bip_noT','E');
                else
                    % Load existing randomly initialized network
                    Eca = load('fig_cluster2_sworld_circle_E_bip_noT');
                    E = Eca.E;
                end
                ...
                if (trig_saveplot)
                    ...
                    try
                        ...
                        % save
                        print(h,sprintf('./figures/sworld_circle/fig_cluster2_sworld_circle_metric-%i_sub%i_noT',iM,iSub),'-depsc');
                        print(h,sprintf('./figures/sworld_circle/fig_cluster2_sworld_circle_metric-%i_sub%i_noT',iM,iSub),'-dpng','-r900');
                        close(h);
                    catch e
                        rethrow(e);
...
%                     end
            ...
            %         fprintf('\tSWI = %.6f\n',I);
                ...
                save(sprintf('cache/fig_cluster2_sworld_circle_subjects_bip-%i_noT.mat',iM));
