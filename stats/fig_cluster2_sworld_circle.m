...
%     rois2 = rois2(cov_idx);
    ...
    % save
    print(h,sprintf('./figures/fig_cluster2_sworld_circle_metric-%i',iM),'-depsc');
    print(h,sprintf('./figures/fig_cluster2_sworld_circle_metric-%i',iM),'-dpng','-r900');
    close(h);
...
%         fprintf('\tSWI = %.6f\n',I);
    ...
    save(sprintf('cache/fig_cluster2_sworld_circle-%i.mat',iM));
...
%     xtickangle(90);
    ...
    print(h,sprintf('./figures/fig_cluster2_sworld_circle_im-%i_swp',iM),'-depsc','-r900');
    print(h,sprintf('./figures/fig_cluster2_sworld_circle_im-%i_swp',iM),'-dpng','-r900');
    close(h);
    %return
%     
%     % Brain metrics
