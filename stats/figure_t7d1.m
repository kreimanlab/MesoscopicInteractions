...
Roi1 = {{'V4'};           {'V1'};  {'V1'};   {'V4'};  {'V1'}... % {'V4'}
        };
Roi2 = {{'TEad','TEpd'};  {'V4'};  {'TEO'};  {'9'};   {'7B'}... % {'8l','8m'} 'TEa_ma','TEa_mp'
        };
% channels for first ROI2
chans2_1 = [125, 128, 127,112,113];
...
is_pos = [true, true, true, false, false];
