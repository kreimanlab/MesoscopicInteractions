...
h5create(h5fname,'/h5eeg/eeg',[N_CHAN-AUX_CHAN Inf],'ChunkSize',[(N_CHAN-AUX_CHAN),Fs*60],'Datatype','single');
...
for file = 1:length(Flist)
    ...
    h5write(h5fname,'/h5eeg/aux',double(data(:,[true,isaux'])'),start,[(1+AUX_CHAN) N_SAMPLES]);
