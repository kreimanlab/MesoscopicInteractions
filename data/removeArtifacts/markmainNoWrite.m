...
function markmainNoWrite(infilearg)
...
% referencing
    ...
    for si = 1:total
        ...
        if (fglob(x_glob(1),x_glob(2)) > 0)
            ...
            %h5write(infile,'/h5eeg/eeg',single(artGlob),startGlob,countGlob);
        ...
        for eSing = 1:N_CHAN
            ...
            if (fsing(x_sing(1),x_sing(2)) > 0)
                ...
                %h5write(infile,'/h5eeg/eeg',single(artSing),startSing,countSing);
