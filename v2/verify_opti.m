...
toggle_sav = false;
toggle_plot = true;
toggle_drawplt = false;
toggle_savplot = false;
...
%                     colormap gray;
                    ...
                    if (toggle_sav)
                        save_verify(sid,art_idx,n_bchan,w,art_width,graph_width,bip,chan_labels,bchan_labels,comb_labels,T_tickval,xlab);
                    end
                end
...
function [ ] = save_verify ( sid,art_idx,n_bchan,w,art_width,graph_width,bip,chan_labels,bchan_labels,comb_labels,T_tickval,xlab )
    save(sprintf('verify/art_idx/%s',sid),'-v6','art_idx','n_bchan','w',...
